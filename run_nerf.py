...
def config_parser():
    ...
    # training options
    parser.add_argument("--N_row", type=int, default=64,
                        help='row batch size')
    parser.add_argument("--N_rowpoint", type=int, default=2,
                        help='row batch size')
    ...
    # rendering options
    parser.add_argument("--rand_sample", default=False,
                        help='sample rows and columns randomly in each iteration')
    parser.add_argument("--multisample", type=int, default=0,
                        help='calculate the multisample at which iteration, 0 for not using multisample')
    parser.add_argument("--fixpose", default=False,
                        help='fix pose when start using multisample')
    ...
    parser.add_argument("--i_vizpose",   type=int, default=10000,
                        help='frequency of vizualization of estimated poses')
    ...
    parser.add_argument("--focal", type=float, default=0., help='focal length')
